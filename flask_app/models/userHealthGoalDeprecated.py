...
from flask_app.models import time_domain
...
class UserHealthGoal:
    ...
    def create_health_goals(cls, form_data):
        ...
        for goal_selection in form_data:
            ...
            existing_check_results = UserHealthGoal.check_for_existing(
                user_id, health_goal_id
            )
            ...
            if existing_check_results == False:
                time_domain_id = time_domain.TimeDomain.create_time_domain()
    ...
    def check_for_existing(cls, user_id, health_goal_id):
        ...
        goal_data = {"user_id": user_id, "health_goal_id": health_goal_id}
    ...
    def find_one_user_health_goal_with_time_domains(cls, health_health_goal_id):
        ...
        user_id = session["user_id"]
        user_health_goal = UserHealthGoal.find_by_user_id_and_health_goal_id(
            user_id, health_health_goal_id
        )
        time_domain_id = user_health_goal.time_domain_id

        time_domain = time_domain.TimeDomain.find_by_id(time_domain_id)
        health_goal = health_goal_deprecated.HealthGoal.find_by_id(
            user_health_goal.health_goal_id
        )
    ...
    def find_by_user_id_and_health_goal_id(cls, user_id, health_health_goal_id):
        ...
        data = {"user_id": user_id, "health_goal_id": health_health_goal_id}
    ...
    def update_user_health_goals(cls, form_data):
        ...
        time_domain.TimeDomain.update_time_domain(form_data)
    ...
    def find_by_user_id_and_time_domain_id(cls, user_id, time_domain_id):
        ...
        data = {"user_id": user_id, "time_domain_id": time_domain_id}
    ...
    def delete_user_health_goal_and_time_domain(cls, health_health_goal_id):
        ...
        time_domain.TimeDomain.delete_time_domain(time_domain_id)
        return
