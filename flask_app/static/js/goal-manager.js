...
function addGoal() {
  ...
  goalCard.innerHTML = `
    ...
    <!-- Goal Type Input -->
    <div class="mb-3">
      <label for="{{ subcategory.subcategory_slug }}-goal-${goalCount}-type" class="form-label">Goal
        Type</label>
      <select class="form-select" id="{{ subcategory.subcategory_slug }}-goal-${goalCount}-type" required>
