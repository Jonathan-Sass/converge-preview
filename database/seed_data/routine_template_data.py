...
routine_template_data = [
    # AM Starter Routines for early users getting their first routines
    {
        ...
        "practices": [
            {"practice_name": "AM Digital Wellness", "routine_block_slug": "core-reset", "position": 1},
            {"practice_name": "Morning Hydration", "routine_block_slug": "core-reset", "position": 2},
            {"practice_name": "Morning Mindfulness", "routine_block_slug": "core-reset", "position": 3}
        ],
        "traits": {
    ...
    },
    {
        ...
        "practices": [
            ...
            {"practice_name": "Morning Hydration", "routine_block_slug": "core-reset", "position": 2},
            {"practice_name": "Morning Sun/Walk", "routine_block_slug": "core-reset", "position": 3}
        ]
    },
    {
        ...
        "practices": [
            {"practice_name": "AM Digital Wellness", "routine_block_slug": "core-reset", "position": 1},
            {"practice_name": "Morning Mindfulness", "routine_block_slug": "core-reset", "position": 2},
    ...
    },
    {
        ...
        "practices": [
            ...
            {"practice_name": "Morning Mindfulness", "routine_block_slug": "core-reset", "position": 2},
            {"practice_name": "AM Digital Wellness", "routine_block_slug": "expanded-core", "position": 3}
        ]
    },
    {
        ...
        "practices": [
            {"practice_name": "Cold Exposure", "routine_block_slug": "core-reset", "position": 1},
            {"practice_name": "Morning Sun/Walk", "routine_block_slug": "core-reset", "position": 2},
            {"practice_name": "Deep Work Session", "routine_block_slug": "productivity", "position": 3}
        ]
    },

    {
        ...
        "practices": [
            {"practice_name": "AM Digital Wellness", "routine_block_slug": "expanded-core", "position": 1}, 
            {"practice_name": "Morning Hydration", "routine_block_slug": "core-reset", "position": 2}, 
            {"practice_name": "Cold Exposure", "routine_block_slug": "core-reset", "position": 3}, 
            {"practice_name": "Morning Mindfulness", "routine_block_slug": "expanded-core", "position": 4}, 
            {"practice_name": "Movement/Stretch", "routine_block_slug": "expanded-core", "position": 5}, 
            {"practice_name": "Morning Sun/Walk", "routine_block_slug": "core-reset", "position": 6}, 
    ...
    },
    {
        ...
        "practices": [
            ...
            {"practice_name": "Cold Exposure", "routine_block_slug": "core-reset", "position": 3}, 
            {"practice_name": "Morning Mindfulness", "routine_block_slug": "expanded-core", "position": 4},
            {"practice_name": "Morning Sun/Walk", "routine_block_slug": "core-reset", "position": 5},
